...
import theImmortal.cards.abstracts.AbstractDynamicCard;
import theImmortal.characters.ImmortalCharacter;

import static theImmortal.TheImmortal.makeCardPath;
...
public class CardTemplate extends AbstractDynamicCard {
    ...
    public static final String ID = theImmortal.TheImmortal.makeID("DefaultCommonAttack"); // DELETE THIS ONE.
    ...
    public static final CardColor COLOR = ImmortalCharacter.Enums.COLOR_IMMORTAL;
