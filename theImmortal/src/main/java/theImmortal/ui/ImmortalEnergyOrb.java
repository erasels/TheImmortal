...
public class ImmortalEnergyOrb extends CustomEnergyOrb {
    public static final String[] orbTextures = {
            TheImmortal.makeCharPath("orb/layerFake.png"),
            TheImmortal.makeCharPath("orb/layerFake.png"),
            TheImmortal.makeCharPath("orb/layerFake.png"),
            TheImmortal.makeCharPath("orb/layerFake.png"),
            TheImmortal.makeCharPath("orb/layerFake.png"),
    ...
    private static final String VFXTexture = TheImmortal.makeCharPath("orb/EnergyRecharge.png");
